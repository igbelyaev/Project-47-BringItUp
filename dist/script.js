...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var showUpSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
    ...
    animate: true,
    btns: '.showup__content-title div'
  });
  showUpSlider.init();
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function init() {
      ...
      firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); // firstScriptTag.parentNode.before(tag);
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides[this.slideIndex - 1].style.display = 'block'; // ТЗ п.8 мое решение
    ...
    value: function animateSlide(slide, start) {
      ...
      slide.style.opacity = String(progress); // console.log(slide.style.opacity);
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, slides) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, slides));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        if (_this2.slides[_this2.slides.length - 1].tagName == "BUTTON") {
          _this2.slides[0].before(_this2.slides[_this2.slides.length - 3]);

          _this2.decorizeSlides();
        } else {
          _this2.slides[0].before(_this2.slides[_this2.slides.length - 1]);
    ...
    value: function autoSwitch() {
      ...
      if (this.autoplay) {
        ...
        this.container.addEventListener('mouseover', function () {
          clearInterval(_this3.switching);
        });
    ...
    value: function switchOn() {
      ...
      this.switching = setInterval(function () {
